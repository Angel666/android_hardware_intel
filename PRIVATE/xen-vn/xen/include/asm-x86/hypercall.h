...
extern long
do_mwait_suspend(unsigned long eax, unsigned long ecx, void *monitor_addr);

extern long
do_mwait_idle(unsigned long eax, unsigned long ecx, void *monitor_addr,
         unsigned long resched_addr);
