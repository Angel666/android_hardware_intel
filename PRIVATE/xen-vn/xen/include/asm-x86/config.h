...
#ifdef CONFIG_CTP
#undef CONFIG_XEN_TIMER
#else
#define CONFIG_XEN_TIMER 1
#endif
...
/*
 * Physical memory layout under 16M for CTP virtualization
 * Resevered, and maybe reused in future (0-1M)
 * Xen code/data/heap                    (1-4M)
 * Frame table                           (4-10M)
 * Xen MPT table                         (10-11M)
 * Reserved by HW                        (11-16M)
 */

#define XEN_HEAP_PHYS_END             4


/* 4M-12M are resevered for frametable */
#define FRAME_TABLE_PHYS_START        XEN_HEAP_PHYS_END
#define FRAME_TABLE_PHYS_END          10

#define XEN_MPT_PHYS_START            FRAME_TABLE_PHYS_END
#define XEN_MPT_PHYS_SIZE             (1UL << 20)
#define XEN_MPT_PHYS_END              11

#define XEN_HV_PHYS_MEM_END           XEN_MPT_PHYS_END
 ...
 *  Frame-info table                                     (32MB)
 *  PSA virtual range                                    (64MB)
...
#define FRAMETABLE_MBYTES       32
#define PSA_MBYTES              64
...
#define FRAMETABLE_VIRT_START	(FRAMETABLE_VIRT_END - FRAMETABLE_SIZE)
#define PSA_VIRT_END            FRAMETABLE_VIRT_START
#define PSA_VIRT_START         (PSA_VIRT_END - (PSA_MBYTES << 20))
#define RO_MPT_VIRT_END		PSA_VIRT_START
