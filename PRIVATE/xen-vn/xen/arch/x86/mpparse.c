...
int __devinit MP_processor_info(struct mpc_config_processor *m)
{
	...
	u32			gsi_base)
{
	...
	mp_ioapic_routing[idx].gsi_end = gsi_base + entries;

	if (gsi_base + entries >= mp_gsi_top)
		mp_gsi_top = gsi_base + entries + 1;
