...
#endif
										PVRSRV_CLIENT_MEM_INFO **ppsMemInfo, IMG_BOOL bNeedMmap);
...
IMG_IMPORT
PVRSRV_ERROR IMG_CALLCONV PVRSRVQueryBlitsComplete( IMG_CONST PVRSRV_CONNECTION *psServices,
										IMG_CONST PVRSRV_MISC_INFO *psMiscInfo,
										PVRSRV_CLIENT_MEM_INFO	*psClientMemInfo);

IMG_IMPORT
PVRSRV_ERROR IMG_CALLCONV SGXInitCamera(IMG_HANDLE *phCamHandle, IMG_UINT32 deviceId);

IMG_IMPORT
PVRSRV_ERROR IMG_CALLCONV SGXDeinitCamera(IMG_HANDLE hCamHandle);

IMG_IMPORT
PVRSRV_ERROR IMG_CALLCONV SGXScaleCamera (IMG_HANDLE hCamHandle, IMG_UINT32 bufferIdx,
								        IMG_UINT32 left, IMG_UINT32 right,
								        IMG_UINT32 top, IMG_UINT32 bottom);
